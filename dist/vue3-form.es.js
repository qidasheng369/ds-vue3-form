                ...
                return openBlock(), createBlock(_component_el_col, {
                  ...
                  default: withCtx(() => [
                    column.slotName ? renderSlot(_ctx.$slots, column.slotName, { key: 0 }) : (openBlock(), createBlock(_component_el_form_item, mergeProps({
                      ...
                      default: withCtx(() => [
                        (openBlock(), createBlock(resolveDynamicComponent(unref(componentsTypes)[column.xType]), mergeProps({ ref_for: true }, column, {
